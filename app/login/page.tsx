    ...
    <div className="min-h-screen bg-white flex">
        ...
        <div className="relative w-full rounded-3xl overflow-hidden">
          ...
          <div className="absolute bottom-10 left-8 right-8">
            <p className="text-white font-medium text-3xl leading-snug mb-3">
              Your paradise<br />is waiting.
            </p>
            <p className="text-white/70 text-sm leading-relaxed">
              Discover pristine beaches, lush rainforests,<br />and the Pura Vida lifestyle.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm mx-auto">
          ...
          <p className="text-[#ff5a00] text-sm font-semibold mb-2">Welcome back</p>
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-sm text-gray-400 hover:text-[#ff5a00] transition-colors font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-sm text-gray-400 font-medium mt-8">
            ...
            <Link href="/register" className="text-[#ff5a00] font-semibold hover:underline">
              Register
            </Link>
          </p>
        </div>
